/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 3af8440de6247a0c58b6e70a2b6b969d)
// Runtime types generated with workerd@1.20260722.1 2026-07-28 nodejs_compat
interface __BaseEnv_Env {
	GRANODIORITE_KV: KVNamespace;
	MIRROR_BUCKET: R2Bucket;
	ANALYTICS_DB: D1Database;
	ASSETS: Fetcher;
	PUBLIC_BUCKET_DOMAIN: "r2.granodiorite.ferris.love";
	MIRROR_NAME: "Granodiorite";
	ADMIN_UUID: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PUBLIC_BUCKET_DOMAIN" | "MIRROR_NAME" | "ADMIN_UUID">> {}
}
